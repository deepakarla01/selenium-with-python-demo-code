...
class Elements(BaseDriver):
    ...
    def navigate_to_textbox_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_textbox_page: {e}"
            )
            return False
    ...
    def navigate_to_checkbox_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_checkbox_page: {e}"
            )
            return False
    ...
    def navigate_to_radiobutton_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_radiobutton_page: {e}"
            )
            return False
    ...
    def navigate_to_webtables_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_webtables_page: {e}"
            )
            return False
    ...
    def navigate_to_buttons_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_buttons_page: {e}"
            )
            return False
    ...
    def navigate_to_links_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_links_page: {e}"
            )
            return False

    def click_broken_links_images(self, url):
        broken_links_images = self.wait_for_presence_of_element(
            By.XPATH, self.BROKEN_LINKS_IMAGES
        )
        self.driver.execute_script(
            "arguments[0].scrollIntoView(true);", broken_links_images
        )
        try:
            ...
            self.log.error(
                "An unexpected error occurred in click_broken_links_images: {e}"
            )
            return False
    ...
    def navigate_to_broken_links_images_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_broken_links_images_page: {e}"
            )
            return False

    def click_upload_and_download(self, url):
        upload_and_download = self.wait_for_presence_of_element(
            By.XPATH, self.UPLOAD_AND_DOWNLOAD
        )
        self.driver.execute_script(
            "arguments[0].scrollIntoView(true);", upload_and_download
        )
        try:
            ...
            self.log.error(
                "An unexpected error occurred in click_upload_and_download: {e}"
            )
            return False
    ...
    def navigate_to_upload_and_download_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_upload_and_download_page: {e}"
            )
            return False

    def click_dynamic_properties(self, url):
        dynamic_properties = self.wait_for_presence_of_element(
            By.XPATH, self.DYNAMIC_PROPERTIES
        )
        self.driver.execute_script(
            "arguments[0].scrollIntoView(true);", dynamic_properties
        )
        try:
            ...
            self.log.error(
                "An unexpected error occurred in click_dynamic_properties: {e}"
            )
            return False
    ...
    def navigate_to_dynamic_properties_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_dynamic_properties_page: {e}"
            )
            return False
