...
class Homepage(BaseDriver):
    ...
    def click_on_elements_card(self):
        ...
        try:
            ...
            self.log.error(
                "An unexpected error occurred in click_on_elements_card: {e}"
            )
            return False
    ...
    def navigate_to_elements_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_elements_page: {e}"
            )
            return False
    ...
    def navigate_to_forms_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_forms_page: {e}"
            )
            return False

    def click_on_alerts_frame_window_card(self):
        alerts_frame_window_card = self.wait_for_presence_of_element(
            By.XPATH, self.ALERTS_FRAME_WINDOW_CARD
        )
        self.driver.execute_script(
            "arguments[0].scrollIntoView(true);", alerts_frame_window_card
        )
        try:
            ...
            self.log.error(
                "An unexpected error occurred in click_on_alerts_frame_window_card: {e}"
            )
            return False
    ...
    def navigate_to_alerts_frame_window_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_alerts_frame_window_page: {e}"
            )
            return False
    ...
    def navigate_to_widgets_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_widgets_page: {e}"
            )
            return False

    def click_on_interactions_card(self):
        interactions_card = self.wait_for_presence_of_element(
            By.XPATH, self.INTERACTIONS_CARD
        )
        self.driver.execute_script(
            "arguments[0].scrollIntoView(true);", interactions_card
        )
        try:
            ...
            self.log.error(
                "An unexpected error occurred in click_on_interactions_card: {e}"
            )
            return False
    ...
    def navigate_to_interactions_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_interactions_page: {e}"
            )
            return False

    def click_on_book_store_app_card(self):
        book_store_app_card = self.wait_for_presence_of_element(
            By.XPATH, self.BOOK_STORE_APP_CARD
        )
        self.driver.execute_script(
            "arguments[0].scrollIntoView(true);", book_store_app_card
        )
        try:
            ...
            self.log.error(
                "An unexpected error occurred in click_on_book_store_app_card: {e}"
            )
            return False
    ...
    def navigate_to_book_store_app_page(self, url):
        ...
        if self.ut.check_expected_url(expected_url, self.driver.current_url):
            ...
            self.log.error(
                "An unexpected error occurred in navigate_to_book_store_app_page: {e}"
            )
            return False
